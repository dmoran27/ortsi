                        ...
                        <div class="box-body">
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-default btn-sm" @click="fetchData">
                                    <i class="fa fa-refresh" :class="{'fa-spin': loading}"></i> Refrescar
                                </button>
                            </div>
                        </div>
                            ...
                            <div class="row" v-if="loading">
                                <div class="col-xs-4 col-xs-offset-4">
                                    <div class="alert text-center">
                                        <i class="fa fa-spin fa-refresh"></i> Cargar
                                    </div>
                                </div>
                            </div>
...
export default {
    data() {
        return {
            columns: [
                ...
                { title: 'Apellido', field: 'apellido', sortable: true },
                { title: 'Cedula', field: 'cedula', sortable: true },
    ...
    computed: {
        ...mapGetters('ClientesIndex', ['data', 'total', 'loading', 'relationships']),
    },
    watch: {
        query: {
            handler(query) {
    ...
    methods: {
        ...mapActions('ClientesIndex', ['fetchData', 'setQuery', 'resetState']),
    }
}
</script>
